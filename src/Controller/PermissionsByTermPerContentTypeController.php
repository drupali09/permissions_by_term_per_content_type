...
namespace Drupal\permissions_by_term_per_content_type\Controller;

use Drupal\Core\Controller\ControllerBase;
use \Drupal\Component\Utility\Tags;
use Symfony\Component\HttpFoundation\JsonResponse;
use \Drupal\permissions_by_term_per_content_type\AccessCheckInterface;
use \Drupal\Component\Utility\Html;
use \Drupal\Core\Access\AccessResult;

/**
 * Default controller for the permissions_by_term_per_content_type module.
 */
class PermissionsByTermPerContentTypeController extends ControllerBase {

  /**
   * PermissionsByTermController constructor.
   *
   * @param \Drupal\permissions_by_term_per_content_type\AccessCheckInterface
   */
